...
class Storage:
    def __init__(self):
        ...
        #-----------------------------features dict 
        self.features_dict = self.load_pickle(f"../models_{self.locker['comp_name']}/features_dict.pkl")
        #----------------------------base features 
        self.useful_features_l1 = self.load_pickle(f"../models_{self.locker['comp_name']}/useful_features_l1.pkl")
        #-----------------------------Table 
        ...
        #---------------------------------container 
        self.names = ["locker","current_dict","features_dict","useful_features_l1", "Table","my_folds","test"]
        self.obj = [self.locker, self.current_dict, self.features_dict, self.useful_features_l1, self.Table, self.my_folds, self.test]
